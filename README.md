# 🤟 SmartSign ISL — Gamified Indian Sign Language Self-Learning Platform
...
- 🤖 **SmartSign AI Assistant**: Groq LLM-powered AI instructor answering queries on handshapes, 3D chest space signing, SOV grammar rules, and deaf culture.
