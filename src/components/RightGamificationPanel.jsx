...
export default function RightGamificationPanel({ userProgress, onSelectTab }) {
  ...
  return (
    <aside className="hidden lg:flex flex-col space-y-4 w-80 xl:w-96 shrink-0 h-[calc(100vh-2rem)] sticky top-4 overflow-y-auto pr-1">
      ...
      {/* Daily Quests Card */}
      <div className="rounded-[24px] bg-[#18252b] border-2 border-[#37464f] p-4 shadow-sm">
        ...
        <div className="space-y-2.5">
          <div className="p-3 rounded-[16px] bg-[#131f24] border-2 border-[#37464f]">
            ...
            <div className="w-full bg-[#37464f] rounded-full h-2.5 p-0.5">
              <div 
