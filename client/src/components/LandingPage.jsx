      ...
      <footer className={`border-t-2 pt-10 pb-8 px-4 sm:px-8 mt-10 transition-colors ${
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-left mb-8">
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={onOpenContact}
              className="w-full py-2.5 px-4 rounded-xl bg-[#1cb0f6] hover:bg-[#159bd6] text-white font-black text-xs uppercase tracking-wider flex items-center justify-center gap-2 shadow-sm transition-all cursor-pointer"
            >
